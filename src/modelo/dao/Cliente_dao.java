...
public class Cliente_dao {
    ...
    public int creat(Cliente cliente) {
        ...
        try {
            ...
            String insertSQL = "INSERT INTO cliente (identificacion, nombre, apellido, direccion, telefono)" + "VALUES(?,?,?,?,?)";
            preparedStmt = dbConection.prepareStatement(insertSQL);

            preparedStmt.setString(1, String.valueOf(cliente.getIdentificacion()));
            preparedStmt.setString(2, cliente.getNombre());
            preparedStmt.setString(3, cliente.getApellido());
            preparedStmt.setString(4, cliente.getDireccion());
            preparedStmt.setString(5, String.valueOf(cliente.getTelefono()));
