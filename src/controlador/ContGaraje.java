        ...
        if (ae.getSource().equals(this.vista.jButtonCreate)) {
            ...
            if (vista.jTextFieldNombre.getText().equals("")||vista.jTextFieldDireccion.getText().equals("")) {
                ...
                if (rep == 0) {
                    ...
                    Garaje garajeCreate = new Garaje();
                    garajeCreate.setNombre(vista.jTextFieldNombre.getText());
                    garajeCreate.setDireccion(vista.jTextFieldDireccion.getText());
                    

                    modelo.creat(garajeCreate);
                    blancosCampos();
                    tabla();
                } else {
